 ...
 * @author Ariel
 */
public class prueba_array_login {
    ...
    public prueba_array_login(){     
    }
    
     public prueba_array_login(int cod,String usu,int con,String nom,String ape,String emp,int cod_rol){
    ...
    String selectSQL = "SELECT * FROM operario where usuario=? and contraseña=? and cod_rol=?";
        ...
        try {
           ...
           new prueba_array_login(rs.getInt(1),rs.getString(2),rs.getInt(3),rs.getString(4),rs.getString(5),rs.getString(6),rs.getInt(7));
            return user;
             }
